...
def matrix_creation(data, stat_type):
    ...
    mat = np.empty(len(names), dtype=dtype)
    mat['name'] = names
    mat['val'] = accdata
    return mat
...
def top_100_matrix(data, stat_type, n=100):
    ...
    # return the selected rows as a list of (name, val) tuples so printing stays the same
...
if top_100_check == "100":
    ...
    print("Top 100 for: ", stat_type)
    #prints top 100 in readable format
    for name, value in top100output:
        print(name, value)
